//code used with permission from "examples" course folder- fileSystemWatch
...
//				///////TO DO//////
//You will have to modify it to add the signal handlers that will kill the process if a fault is being injected.
//
